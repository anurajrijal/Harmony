...
export default function Greetings() {
  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-8">
      {/* Header */}
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 bg-[#0B0D12] p-8 rounded-[32px] border border-white/5 shadow-2xl relative overflow-hidden">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        {/* Welcome Settings */}
        <div className="bg-[#0B0D12] p-8 rounded-[32px] border border-white/5 shadow-2xl space-y-6 relative overflow-hidden">
      ...
      <div className="bg-[#0B0D12] p-8 rounded-[32px] border border-white/5 shadow-2xl space-y-6">
